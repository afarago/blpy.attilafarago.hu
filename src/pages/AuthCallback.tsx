...
const AuthCallbackPage: React.FC = () => {
    ...
    const hasError = !!error || !code || !redirect_uri || !scope || !state;
        ...
        const exchangeCodeForToken = async () => {
            if (!hasError) {
                try {
                    ...
                    // also update the location history adding the token as param
    ...
    useEffect(() => {
        ...
        if (isElectron && token) {
            ...
            window.location.href = `${APP_PROTOCOL}://oauth-callback?${params.toString()}`;
